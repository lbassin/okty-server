...
class ProjectBuilder
{
    ...
    public function build(array $containers): array
    {
        ...
        return array_merge(
            [['name' => 'docker-compose.yaml', 'content' => $this->stringify($compose)]],
            $output
        );
    }

    private function stringify(array $compose): string
    {
        $output = YAML::dump($compose, 5);
        $header = "# Generated by Okty.io" . PHP_EOL;
